...
def _check_fetch_url_large_md_truncates() -> None:
    ...
    with mock.patch.object(tools.requests, "get", return_value=_FakeResponse(big_html)):
    ...
    print("✓ fetch_url truncates oversized markdown with a recovery hint")
...
def _check_fetch_url_request_failure() -> None:
    ...
    print("✓ fetch_url surfaces network failures as <request failed: ...>")
...
def main() -> None:
    ...
    print("test_html_tools: all checks passed")
