...
### Descriptions
The description is the line beside the link in the index — what
future-you (or `recall_memory`) reads to decide whether to fetch
the body. A good description:
...
Empty description is allowed but it costs you — recall has only
the title and filename to work with.
