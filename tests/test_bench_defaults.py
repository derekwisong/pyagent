...
Run with:
    .venv/bin/python -m tests.test_bench_defaults
"""
...
def _check_anthropic_tiers() -> None:
    ...
    assert _default_budget_for("anthropic/claude-haiku-4-5-20251001") == 0.20
    print("✓ Anthropic per-tier budgets: Opus $3.00 / Sonnet $0.50 / Haiku $0.20")
...
def _check_other_providers() -> None:
    ...
    print(
        "✓ Non-Anthropic budgets: gpt-4o $0.50 / gpt-4o-mini $0.10 / "
        "gemini-flash $0.10"
    )
