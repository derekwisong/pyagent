...
Run with:
    ...
    .venv/bin/python -m tests.test_glob
"""
...
def main() -> None:
    tmp = Path(tempfile.mkdtemp(prefix="pyagent-test-glob-")).resolve()
    ...
    outside = Path(tempfile.mkdtemp(prefix="pyagent-test-glob-outside-")).resolve()
