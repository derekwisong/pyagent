...
Run with:
    ...
    .venv/bin/python -m tests.test_edit_file
"""
...
def main() -> None:
    tmp = Path(tempfile.mkdtemp(prefix="pyagent-test-edit-"))
    ...
    outside = Path(tempfile.mkdtemp(prefix="pyagent-test-edit-outside-"))
