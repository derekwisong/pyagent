...
Run with:
    ...
    .venv/bin/python -m tests.test_pip_safety
"""
...
def main() -> None:
    blocked = [
        ("pip install foo --break-system-packages", "--break-system-packages"),
        ("pip3 install --break-system-packages requests", "--break-system-packages"),
