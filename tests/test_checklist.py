...
Run with:
    ...
    .venv/bin/python -m tests.test_checklist
"""
...
def main() -> None:
    ...
    _update_agents_state(
        agents,
        {
            ...
            "tasks": [
                ...
                {"id": "t-2", "title": "run tests", "status": "pending", "note": ""},
                {
                    "id": "t-3",
                    "title": "update README",
                    "status": "pending",
    ...
    _update_agents_state(
        agents,
        {
            "type": "checklist",
            "tasks": [
                {"id": "t-1", "title": "x", "status": "completed", "note": ""},
                {"id": "t-2", "title": "y", "status": "completed", "note": ""},
            ],
        },
    )
    ...
    _update_agents_state(
        agents,
        {
            "type": "checklist",
            "tasks": [
                {"id": "t-1", "title": long_title, "status": "in_progress", "note": ""},
                {"id": "t-2", "title": "next", "status": "pending", "note": ""},
            ],
        },
    )
    seg = _checklist_segment(agents)
